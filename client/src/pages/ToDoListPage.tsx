...
const ToDoListPage = () => {
  ...
  // Defensive: ensure tasks is always an array before filtering
  ...
  const sortedTasks = (() => {
    switch (sortStrategy) {
      ...
      case "completion":
        return TaskSortingStrategy.sortByCompletion(filteredTasks);
      default:
      ...
      <div className="w-full max-w-3xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2">
            ...
            />
            <ActionButton action="add" onClick={() => setIsModalOpen(true)} />
          </div>
        </div>
        <TaskFormModal
          isOpen={isModalOpen}
